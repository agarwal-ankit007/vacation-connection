...
<style>
    ...
    .dropdown-menu button:hover {
        background: rgba(20, 100, 80, 1) !important;
        color: white;
    }
    ...
    <div class="super_container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col d-flex flex-row">
                            <div class="phone">+91 - 9113916177, 9304332355</div>
                            <div class="social">
                                <ul class="social_list">
                                    <li class="social_list_item"><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li class="social_list_item"><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li class="social_list_item"><a href="https://www.instagram.com/_bizzare_artist?r=nametag" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                    <li class="social_list_item"><a href="#"><i class="fa fa-snapchat" aria-hidden="true"></i></a></li>
                                    <li class="social_list_item"><a href="https://www.linkedin.com/in/ankit-agarwal-87331a17b" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                </ul>
                            </div>

                            <div class="user_box ml-auto" id="fix">
                                <div class="user_box_login user_box_link uname"><?php echo $username; ?></div>


                                <div class="user_box_register user_box_link  profile">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" style="background:transparent;border:none;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#bookingdetails">
                                                Booking Details
                                            </button>
                                            <form method="post">
                                            <button  name="logout" style="left:22px; padding:5px;padding-left:10px;padding:5px;padding-right:10px;border-top-right-radius:5px;border-top-left-radius:5px;border-bottom-right-radius:5px;border-bottom-left-radius:5px;">Logout</button>
                                            </form>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="searchbar">
                                <form action="city_search.php" method="post">
                ...
                <div class="owl-carousel owl-theme home_slider">
                        ...
                        <div class="home_slider_content text-center">
                            <div class="home_slider_content_inner" data-animation-in="flipInX" data-animation-out="animate-out fadeOut">
                                ...
                                <div class="button home_slider_button">
                                    <div class="button_bcg"></div><a href="./offers.html">explore now<span></span><span></span><span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="owl-item home_slider_item">
                        ...
                        <div class="home_slider_content text-center">
                            <div class="home_slider_content_inner" data-animation-in="flipInX" data-animation-out="animate-out fadeOut">
                                <h1>i travel</h1>
                                <h1>not to go anywhere but to go.</h1>
                                <div class="button home_slider_button">
                                    <div class="button_bcg"></div><a href="./offers.html">explore now<span></span><span></span><span></span></a>
                                </div>
                            </div>
                    ...
                    <div class="owl-item home_slider_item">
                        ...
                        <div class="home_slider_content text-center">
                            <div class="home_slider_content_inner" data-animation-in="flipInX" data-animation-out="animate-out fadeOut">
                                <h1>Let's find</h1>
                                <h1>some beautiful place to get lost.</h1>
                                <div class="button home_slider_button">
                                    <div class="button_bcg"></div><a href="./offers.html">explore now<span></span><span></span><span></span></a>
                                </div>
                            </div>
                    ...
                    <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="33px" viewBox="0 0 28 33" enable-background="new 0 0 28 33" xml:space="preserve">
                        <defs>
                            <linearGradient id='home_grad_prev'>
                                ...
                                <stop offset='100%' stop-color='#447D5A' />
                            </linearGradient>
                        </defs>
                    ...
                    <div class="col fill_height">
                        ...
                        <div class="search_tabs_container">
                            <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                ...
                                <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/bus.png" alt="">cabs and rentals</div>
                        ...
                        <div class="search_panel">
                            <form action="disp_car.php" method="post" id="search_form_2" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                ...
                                <div class="search_item">
                                    <div>Travel Date</div>
                                    <input type="date" name="tdate" min="<?php echo $tom ?>" class="check_out search_input" placeholder="YYYY-MM-DD" required="required">
                                </div>
                                <div class="search_item">
                                    <div>Days</div>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="intro_text text-center">
                            <p>Why settle for expensive tour packages when you can make your own!<br>Introducing the facility of customizing the tour packages.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="intro_item">
                            ...
                            <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="intro_center text-center">
                                    <h1>Mumbai</h1>
                                    <div class="intro_price">From inr 1450</div>
                        ...
                        <div class="cta_slider_container">
                            <div class="owl-carousel owl-theme cta_slider">
                                ...
                                <div class="owl-item cta_item text-center">
                                    <div class="cta_title">Manali deluxe package</div>
                                ...
                                <!-- CTA Slider Item -->
                                <div class="owl-item cta_item text-center">
                                    <div class="cta_title">Shimla deluxe package</div>
                                    <div class="rating_r rating_r_4">
                                        <i></i>
                                        <i></i>
                                        <i></i>
                                ...
                                <!-- CTA Slider Item -->
                                <div class="owl-item cta_item text-center">
                                    <div class="cta_title">Goa deluxe package</div>
                                    <div class="rating_r rating_r_4">
                                        <i></i>
                                        <i></i>
                                        <i></i>
                                        ...
                                        <div class="test_content_container">
                                            <div class="test_content">
                                                <div class="test_item_info">
                                                    <div class="test_name">megan fox</div>
        ...
        <div class="trending">
            <div class="container">
                ...
                <div class="row trending_container" style="display: flex; flex-direction: row; flex-wrap: wrap;">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="trending_item clearfix">
                            ...
                            <div class="trending_content">
                                ...
                                <div class="trending_price">From 14,999 inr</div>
        ...
        <!-- Modal -->
      <!--  <div class="modal fade" id="profileinfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        ...
        <div class="modal fade" id="bookingdetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <ul>
                        <li><a href="flight_details.php">flights</a></li>
                        <li><a href="hotel_details.php">hotels</a></li>
                        <li><a href="car_details.php">cars</a></li>
