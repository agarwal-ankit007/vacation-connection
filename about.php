...
<div class="super_container">
                                ...
                                <div class="user_box_register user_box_link  profile">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#profileinfo">
                                                Profile Info
                                            </button>
                                            ...
                                            <button type="button" name="logout" style="left:22px; padding:5px;padding-left:10px;padding:5px;padding-right:10px;">Logout</button>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/about1_back.jpg"></div>
	...
	<div class="add" style="padding-bottom: 50px;">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="add_container">
						<div class="add_background" style="background-image:url(images/udaipur.jpg)"></div>
						<div class="add_content">
							<h1 class="add_title">Udaipur</h1>
							<div class="add_subtitle">From <span>inr 10,000/-</span></div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by vacation connection developers
     ...
     <!-- Modal -->
       ...
       <?php 
          ...
          $sql1 = "SELECT * From books_hotel Where cus_id='$cus_id';";
