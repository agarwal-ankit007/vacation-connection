                ...
                <div class="search_inner search-back">
                    ...
                    <div class="container fill_height no-padding">
                        <div class="row fill_height no-margin">
                            ...
                            <form action="disp_flight.php" method="post" id="search_form_3" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
